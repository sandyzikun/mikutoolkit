...
class Linsep_Binary_Normal_Dataset(object):
    ...
    def dataplot(ミク, axis=( 0 , 1 ), labels=[ "pos" , "neg" ]):
        ...
        plt.scatter(x=ミク.__X[ : ミク.__numhalf , axis[0] ], y=ミク.__X[ : ミク.__numhalf , axis[1] ], label=labels[0])
        plt.scatter(x=ミク.__X[ ミク.__numhalf : , axis[0] ], y=ミク.__X[ ミク.__numhalf : , axis[1] ], label=labels[1])
